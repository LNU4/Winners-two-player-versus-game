 ...
 * @readonly
 */
Object.defineProperty(Winners.entity.Player2.prototype, "bullets", {
  /**
...
Winners.entity.Player2.prototype.m_updateInput = function () {
  ...
  if (this.keyboard.pressed("RIGHT") || gamepad.stickLeftRight) {
    ...
    this.rotation = 90;
    this.animation.gotoAndPlay("walk") || gamepad.stickLeftLeft;
  }

  if (this.keyboard.pressed("LEFT") || gamepad.stickLeftUp) {
    this.velocity.x -= 0.15;
    //this.flippedX = true;
    this.rotation = -90;
